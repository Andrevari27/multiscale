...
function loadFormattedValue() {
	...
	<div class="content">
		...
		<div class="container-fluid">
			<div class="page-title-box">
				<form action="<?= base_url() ?>barang/update/<?= $barang['kode_brng'] ?>" method="POST" enctype="multipart/form-data">
					<div class="row">
						<div class="col-12">
							<div class="form-group row">
								...
								<div class="col-sm-10">
									<input class="form-control" type="text" placeholder="Kode Barang"
										   name="kode_brng" value="<?= $barang['kode_brng'] ?>" required>
								</div>
							</div>
                            <div class="form-group row">
								...
								<div class="col-sm-10">
									<input class="form-control" type="text" placeholder="Nama Barang"
										   name="nama_brng" value="<?= $barang['nama_brng'] ?>" required>
								</div>
							</div>
                            <!-- <div class="form-group row">
								...
								<div class="col-sm-10">
									<input class="form-control" type="text" placeholder="Satuan"
										   name="kode_sat" value="<?= $barang['kode_sat'] ?>">
								</div>
							</div> -->
                            <!-- <?php
                            ...
                            <!-- <div class="form-group row">
								...
								<div class="col-sm-10">
									<input class="form-control" type="text" placeholder="Harga"
										   name="harga" value="<?= $barang['harga'] ?>" oninput="formatCurrency(this)">
								</div>
							</div> -->
						</div> <!-- end col -->
					</div>
