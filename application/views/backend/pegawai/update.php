                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-5">
                                    <input class="form-control" type="number" placeholder="NIP" name="nip"
                                        value="<?= $pegawai['nip'] ?>" required>
                                </div>
                                <label for="" class="col-sm-1 col-form-label">NIK</label>
                                <div class="col-sm-5">
                                    <input class="form-control" type="number" placeholder="NIK" name="nik"
                                        value="<?= $pegawai['nik'] ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-5">
                                    <input class="form-control" type="text" placeholder="Jabatan" name="jbtn"
                                        value="<?= $pegawai['jbtn'] ?>">
                                </div>
                                <label for="" class="col-sm-1 col-form-label">Departemen</label>
                                <div class="col-sm-5">
                                    <input class="form-control" type="text" placeholder="Departemen" name="departemen"
                                        value="<?= $pegawai['departemen'] ?>" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="" class="col-sm-1 col-form-label">NPWP</label>
                                <div class="col-sm-5">
                                    <input class="form-control" type="text" placeholder="NPWP" name="npwp"
                                        value="<?= $pegawai['npwp'] ?>">
                                </div>
                                <label for="" class="col-sm-1 col-form-label">Pendidikan</label>
                                <div class="col-sm-5">
                                    <input class="form-control" type="text" placeholder="Pendidikan" name="pendidikan"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-5">
                                    <input class="form-control" type="text" placeholder="Tempat Lahir" name="tmp_lahir"
                                        value="<?= $pegawai['tmp_lahir'] ?>" required>
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-5">
                                    <input class="form-control" type="text" placeholder="kota" name="kota"
                                        value="<?= $pegawai['kota'] ?>" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="" class="col-sm-1 col-form-label">Mulai Kerja</label>
                                <div class="col-sm-5">
                                    <input class="form-control" type="date" name="mulai_kerja"
                                        value="<?= $pegawai['mulai_kerja'] ?>" required>
                                </div>
                                <label for="" class="col-sm-1 col-form-label">Rekening</label>
                                <div class="col-sm-5">
                                    <input class="form-control" type="number" placeholder="No Rekening" name="rekening"
                                        value="<?= $pegawai['rekening'] ?>" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="" class="col-sm-1 col-form-label">Photo TTD</label>
                                <div class="col-sm-5">
                                    <input class="form-control" type="file" placeholder="Foto" name="photo"
                                        value="<?= $pegawai['photo'] ?>">
                                </div>
                            </div>
                        </div> <!-- end col -->
